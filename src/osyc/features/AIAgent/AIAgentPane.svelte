...
<style>
    ...
    .ai-activation { gap: 10px; width: min(100%, 360px); margin-top: 8vh; }
    /* 激活卡独占首屏：没激活时不再渲染上方的欢迎区，这里再留出键盘高度的滚动余量，
       手机弹出键盘后仍能把输入框和"激活"按钮滚进可视区（历史回归：禁止 scrollIntoView 整页滚动）。 */
    .ai-chat-timeline.ai-timeline-activating { padding-bottom: max(30vh, 160px); }
    ...
    @media (max-width: 720px) {
        ...
        .ai-activation { margin-top: 3vh; }
        .ai-chat-timeline.ai-timeline-activating { padding-bottom: max(38vh, 200px); }
